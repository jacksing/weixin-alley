...
class UserConfig(object):
    weixin_login_domain = 'https://open.weixin.qq.com'
    ...
    # def qr_url(self):
    #     return (
    #         '{weixin_login_domain}/connect/qrconnect'
    #         '?appid={appid}'
    ...
    #         '&scope=snsapi_login'
    #     ).format(
    #         weixin_login_domain=self.weixin_login_domain,
    #         appid=self.appid,
